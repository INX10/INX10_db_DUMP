SELECT i.user_ID AS i_employee_ID, CONCAT(i.first_name, ' ', i.middle_name, ' ', i.last_name) AS employee_name, 
	CONCAT(j.job_title, ', ', d.department_name) AS emp_job, st.start_date,
